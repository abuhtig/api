...
router.post('/deleteLogs', AdminController.deleteLogs)
router.post('/uploadImg', AdminController.uploadImg)
router.post('/uploadAdvert', AdminController.uploadAdvert)
router.post('/deleteAdvert', AdminController.deleteAdvert)
